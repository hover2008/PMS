...
namespace JW.Core.Helper
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new CKException("Email is not valid.");
            }
        ...
        public static object GetPrivateFieldValue(object target, string fieldName)
        {
            ...
            if (fi == null)
            {
                throw new CKException($"Field '{fieldName}' not found in type hierarchy.");
            }
        ...
        /// 获取或设置默认文件提供程序
        /// </summary>
        public static ICKFileProvider DefaultFileProvider { get; set; }
