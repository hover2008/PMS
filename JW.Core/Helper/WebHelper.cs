...
namespace JW.Core.Helper
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        private readonly ICKFileProvider _fileProvider;
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items["JW.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["JW.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContextAccessor.HttpContext.Items["JW.IsPOSTBeingDone"] = value;
            }
        }
