...
namespace JW.Services.CMS.Service
{
    ...
    /// 模型服务
    /// </summary>
    public partial class HTBCTKService : BaseService<HTBCTKEntity, IHTBCTKRepository<HTBCTKEntity>>, IHTBCTKService<HTBCTKEntity>
    {
        #region Fields

        private readonly IHTBCTKRepository<HTBCTKEntity> repository;
        ...
        public HTBCTKService(IHTBCTKRepository<HTBCTKEntity> repository,
            Messages messages)
            : base(repository)
        {
        ...
        public Messages Save(HTBCTKEntity model)
        {
        ...
        public Task<BasePagedListModel<HTBCTKEntity>> GetListAsync(HTBCTKSearchParam param)
        {
            if (param == null)
        ...
        /// </summary>
        /// <returns></returns>
        public Task<IEnumerable<SelectHTBCTKEntity>> GetSelectCanUseListAsync()
        {
