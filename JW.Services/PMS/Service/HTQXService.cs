...
namespace JW.Services.CMS.Service
{
    ...
    /// 模型服务
    /// </summary>
    public partial class HTQXService : BaseService<HTQXEntity, IHTQXRepository<HTQXEntity>>, IHTQXService<HTQXEntity>
    {
        #region Fields

        private readonly IHTQXRepository<HTQXEntity> repository;
        ...
        public HTQXService(IHTQXRepository<HTQXEntity> repository,
            Messages messages)
            : base(repository)
        {
        ...
        public Messages Save(HTQXEntity model)
        {
            if (model != null && model.Name.IsNotNullOrEmpty() && model.Months > 0)
            {
        ...
        public Task<BasePagedListModel<HTQXEntity>> GetListAsync(HTQXSearchParam param)
        {
            if (param == null)
        ...
        /// </summary>
        /// <returns></returns>
        public Task<IEnumerable<SelectHTQXEntity>> GetSelectCanUseListAsync()
        {
