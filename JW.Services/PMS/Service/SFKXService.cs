...
namespace JW.Services.CMS.Service
{
    ...
    /// 模型服务
    /// </summary>
    public partial class SFKXService : BaseService<SFKXEntity, ISFKXRepository<SFKXEntity>>, ISFKXService<SFKXEntity>
    {
        #region Fields

        private readonly ISFKXRepository<SFKXEntity> repository;
        ...
        public SFKXService(ISFKXRepository<SFKXEntity> repository,
            Messages messages)
            : base(repository)
        {
        ...
        public Messages Save(SFKXEntity model)
        {
            if (model != null && model.Name.IsNotNullOrEmpty())
            {
                model.DefaultUnit = model.DefaultUnit ?? "";
                model.DefaultMode = model.DefaultMode ?? "";
        ...
        public Task<BasePagedListModel<SFKXEntity>> GetListAsync(SFKXSearchParam param)
        {
            if (param == null)
        ...
        /// </summary>
        /// <returns></returns>
        public Task<IEnumerable<SelectSFKXEntity>> GetSelectCanUseListAsync()
        {
