...
namespace JW.Services.CMS.Service
{
    ...
    /// 模型服务
    /// </summary>
    public partial class JFFSService : BaseService<JFFSEntity, IJFFSRepository<JFFSEntity>>, IJFFSService<JFFSEntity>
    {
        #region Fields

        private readonly IJFFSRepository<JFFSEntity> repository;
        ...
        public JFFSService(IJFFSRepository<JFFSEntity> repository,
            Messages messages)
            : base(repository)
        {
        ...
        public Messages Save(JFFSEntity model)
        {
        ...
        public Task<BasePagedListModel<JFFSEntity>> GetListAsync(JFFSSearchParam param)
        {
            if (param == null)
        ...
        /// </summary>
        /// <returns></returns>
        public Task<IEnumerable<SelectJFFSEntity>> GetSelectCanUseListAsync()
        {
