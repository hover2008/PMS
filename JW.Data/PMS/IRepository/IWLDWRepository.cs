...
{
    public partial interface IWLDWRepository<TEntity> : IBaseRepository<TEntity> where TEntity : BaseEntity
    {
        #region Methods
        ...
        Task<BasePagedListModel<TEntity>> GetListAsync(WLDWSearchParam param);
